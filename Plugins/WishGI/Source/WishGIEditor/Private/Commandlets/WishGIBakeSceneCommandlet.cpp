...
#include "../Bake/WishGIAssetWriter.inl"
#include "../Bake/WishGIProbeSolver.inl"
#include "../Bake/Backends/WishGILineTraceBackend.inl"
#include "../Bake/WishGIBakeOrchestrator.inl"
}
...
int32 UWishGIBakeSceneCommandlet::Main(const FString& Params)
{
	...
	return WishGIBakeScene::ExecuteBake(Settings);
}
